...
//** Nguong bien duong (lane) **//
    ...
    // Scalar minHSV_lane = Scalar(34, 74, 98);
    // Scalar maxHSV_lane = Scalar(114, 255, 255);
    // Scalar minHSV_lane = Scalar(0, 26, 212);
    // Scalar maxHSV_lane = Scalar(95, 255, 255);
